...
Bubbles = () ->
  ...
  # drawing the Pie chart ( timeline)
    ...
    node.append("image")
    .attr("xlink:href", "glyph-empty.png")
        .attr("width",  (d) -> rScale(rValue(d)) / 2 )
        .attr("height", (d) -> rScale(rValue(d)) / 2 )
    ...
    node.append("image")
    .attr("xlink:href", (d)-> if d.policy == 'y' then "glyph-right.png")
        .attr("width",  (d) -> rScale(rValue(d)) / 2 )
        .attr("height", (d) -> rScale(rValue(d)) / 2 )
        .style("transform", "translate(-1%, -3%)")
        .style("transform-origin","6px 56px;")
    ...
    node.append("image")
        .attr("xlink:href", (d)-> if d.monitor == 'y' then "glyph-left.png")
        .attr("width",  (d) -> rScale(rValue(d)) / 2 )
        .attr("height", (d) -> rScale(rValue(d)) / 2 )
        .style("transform", "translate(-1%, -3%)")
        .style("transform-origin","6px 56px;")
    ...
    node.append("image")
        .attr("xlink:href", (d)-> if d.survey == 'y' then "glyph-top.png")
        .attr("width",  (d) -> rScale(rValue(d)) / 2 )
        .attr("height", (d) -> rScale(rValue(d)) / 2 )
        .style("transform", "translate(-1%, -3%)")
        .style("transform-origin","6px 56px;")
    ...
    node.append("image")
        .attr("xlink:href", (d)-> if d.promotion == 'y' then "glyph-diagonal-right.png")
       .attr("width",  (d) -> rScale(rValue(d)) / 2 )
        .attr("height", (d) -> rScale(rValue(d)) / 2 )
        .style("transform", "translate(-1%, -3%)")
        .style("transform-origin","6px 56px;")
    ...
    node.append("image")
        .attr("xlink:href", (d)-> if d.registration == 'y' then "glyph-diagonal-left.png")
        .attr("width",  (d) -> rScale(rValue(d)) / 2 )
        .attr("height", (d) -> rScale(rValue(d)) / 2 )
        .style("transform", "translate(-1%, -3%)")
        .style("transform-origin","6px 56px;")
